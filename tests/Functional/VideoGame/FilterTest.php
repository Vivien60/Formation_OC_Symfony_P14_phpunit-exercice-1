...
final class FilterTest extends FunctionalTestCase
{
    ...
    public function testShouldShowVideoGamesByUseCase(
        ...
        if ($expectedPage === null) {
            ...
            foreach ($expectedPaginationLinks as $expectedPaginationLink) {
                self::assertAnySelectorTextSame('li.page-item .page-link', $expectedPaginationLink);
            }
        }
        foreach (array_values($expectedVideoGames) as $index => $expectedVideoGame) {
            self::assertSelectorTextSame(
                sprintf('article.game-card:nth-child(%d) .game-card-title a', $index + 1),
                $expectedVideoGame
            );
        }
    }
    ...
    public function testShouldSortVideoGames(): void
    {
        ...
        self::assertSelectorTextSame(
            'article.game-card:nth-child(1) .game-card-title a',
            'Jeu vidéo 0'
        );
        self::assertSelectorTextSame(
            'article.game-card:nth-child(10) .game-card-title a',
            'Jeu vidéo 9'
        );
        ...
        self::assertSelectorTextSame(
            'article.game-card:nth-child(25) .game-card-title a',
            'Jeu vidéo 30'
        );
    }
    ...
    public function testShouldFilterByTagsVideoGames(): void
    {
        ...
        self::assertSelectorTextSame(
            'article.game-card:nth-child(2) .game-card-title a',
            'Jeu vidéo 25'
        );
    }
